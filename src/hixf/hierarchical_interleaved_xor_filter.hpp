...
public:
     ...
     * \{
     */
    hierarchical_interleaved_xor_filter() = default;                                              //!< Defaulted.
    hierarchical_interleaved_xor_filter(hierarchical_interleaved_xor_filter const &) = default; //!< Defaulted.
    hierarchical_interleaved_xor_filter &
    operator=(hierarchical_interleaved_xor_filter const &) = default;                        //!< Defaulted.
    hierarchical_interleaved_xor_filter(hierarchical_interleaved_xor_filter &&) = default; //!< Defaulted.
    hierarchical_interleaved_xor_filter &
    operator=(hierarchical_interleaved_xor_filter &&) = default; //!< Defaulted.
    ~hierarchical_interleaved_xor_filter() = default;            //!< Defaulted.
